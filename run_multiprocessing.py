"""
run_multiprocessing.py - For Multiprocessing Benchmark
========================================================
...
Output:
    - benchmark_multiprocessing.txt: Detailed log
    - benchmark_multiprocessing.csv: Results table
    - benchmark_multiprocessing.json: Structured data
    - performance_multiprocessing.png: Visualization charts
"""
...
# ============================================================================
# BENCHMARK EXECUTION (MULTIPROCESSING ONLY)
# ============================================================================

def run_benchmark_mp(func, image_arrays, num_workers=None, mode='seq'):
    """
    Execute benchmark using multiprocessing module only.
    
    Modes:
        - 'seq': Sequential processing (baseline)
        - 'mp_pool': Pixel-level with multiprocessing.Pool
        - 'mp_map': Image-level with pool.starmap
        - 'direct': Task-level (function manages its own pool)
    """
